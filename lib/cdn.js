...
function _formatDuration(duration, options) {var _ref22, _options$locale10, _options$format, _options$zero, _options$delimiter, _options$maxUnits;
  ...
  var maxUnits = (_options$maxUnits = options === null || options === void 0 ? void 0 : options.maxUnits) !== null && _options$maxUnits !== void 0 ? _options$maxUnits : format2.length;
  if (!locale.formatDistance) {
    return "";
  }
  var result = format2.reduce(function (acc, unit) {
    if (acc.length >= maxUnits)
    return acc;
...
//# debugId=9866C392E7098CFB64756E2164756E21
